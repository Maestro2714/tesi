...
module.exports = require('./MapStore2/build/buildConfig')({
    bundles: {
        'MyMapStoreThesis': path.join(__dirname, "js", "app"),
        'MyMapStoreThesis-embedded': path.join(__dirname, "js", "embedded"),
        'MyMapStoreThesis-api': path.join(__dirname, "MapStore2", "web", "client", "product", "api"),
    ...
    cssPrefix: '.MyMapStoreThesis',
    prodPlugins: [
        new HtmlWebpackPlugin({
            template: path.join(__dirname, 'indexTemplate.html'),
            chunks: ['MyMapStoreThesis'],
            publicPath: 'dist/',
            inject: "body",
            hash: true
        }),
        new HtmlWebpackPlugin({
            ...
            chunks: ['MyMapStoreThesis-embedded'],
            publicPath: 'dist/',
            inject: "body",
            hash: true,
